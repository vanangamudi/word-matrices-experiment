...
from model.conv_embedding import Model as Model
...
if __name__ == '__main__':
    ...
    predict_parser.add_argument('--count', default=10, dest='prediction_count')
    ...
    if args.task == 'predict':
        for i in range(int(args.prediction_count)):
            try:
